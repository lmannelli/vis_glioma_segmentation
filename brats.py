...
class BraTS(Dataset):
    def __init__(self, patients_dir, patient_ids, mode, target_size = (128, 128, 128), version="brats2023"):
        ...
        if (mode == "train" or mode == "val" or mode == "test") and version == "brats2023" :
            self.pattens += ["-seg"]
        elif (mode == "train" or mode == "val" or mode == "test") and (version == "brats2019" or version == "brats2020"):
            self.pattens += ["_seg"]
        ...
        for patient_id in patient_ids:
            ...
            patient = dict(
                ...
                t2=paths[2], flair=paths[3], seg=paths[4] if mode == "train" or mode == "val" or mode == "test" or mode == "visualize" else None
            )
